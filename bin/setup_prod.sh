...
oc set resources dc/tasks-blue --limits=memory=1536Mi,cpu=1000m --requests=memory=256Mi,cpu=50m -n ${GUID}-tasks-prod
...
oc set resources dc/tasks-green --limits=memory=1536Mi,cpu=1000m --requests=memory=256Mi,cpu=50m -n ${GUID}-tasks-prod
# Setting 'wrong' VERSION. This will need to be updated in the pipeline
